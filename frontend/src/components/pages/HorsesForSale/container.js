      ...
      <>
        <div className={style.secciones}>
          ...
          <div className={style.seccion}>
            ...
            <p>
              {' '}
              Menard Polo can also become a marketing platform for horses you wish to sell. With our large
              network of partners we will be able to market your horse to the right people within the industry.
              We do not sell any horse for anyone. Each horse advertised by us has to meet certain criteria to
              ensure we are only selling top quality horses.
            </p>
          </div>
          <div className={style.seccion}>
            ...
            <p>
              ...
              partners and can offer access to hundreds of horses worldwide. This comes with our neutral advice
              to make sure you walk away with the best possible horse for your needs.
            </p>
          </div>
          <div>
            <span>
